...
<Workset version="7">
  <WorksetName>audit-json</WorksetName>
  <Options auto-reload="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">C:/java/data/git/audit-json/target/classes</ClasspathPart>
    <ClasspathPart type="bin-class">C:/java/data/dev/head/core-server/build/classes/</ClasspathPart>
  </Classpath>
  <ViewFilters>
